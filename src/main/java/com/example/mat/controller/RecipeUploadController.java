...
public class RecipeUploadController {
  ...
  @PostMapping("/step")
  public ResponseEntity<UploadResultDto> uploadStepImage(MultipartFile uploadFiles) {
    return handleImageUpload(uploadFiles, stepUploadPath);
  }

  @PostMapping("/image")
  public ResponseEntity<UploadResultDto> uploadRecipeImage(MultipartFile uploadFiles) {
    return handleImageUpload(uploadFiles, imageUploadPath);
  }
