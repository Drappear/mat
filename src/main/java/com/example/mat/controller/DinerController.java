...
public class DinerController {
    ...
    @PostMapping("/modify")
    public String postDinerModify(DinerDto dinerDto, @ModelAttribute("requestDto") PageRequestDto pageRequestDto, RedirectAttributes rttr) {
    ...
    @PostMapping("/delete")
    public String postDinerDelete(@RequestParam Long did, @ModelAttribute("requestDto") PageRequestDto pageRequestDto, RedirectAttributes rttr) {
        log.info("식당 삭제 {}", did);
